...
import com.example.projectfitness.activity.inside.ExtendedStartButtonCreateWorkout
...
fun WorkoutDetails(
    ...
    Scaffold(
        ...
        topBar = {
            HomeTopBarWorkoutDetails(navController)
        },
...
@Composable
fun HomeTopBarWorkoutDetails(navController: NavController) {
    Row(
        modifier = Modifier
            .fillMaxWidth()
        ...
        IconButton(onClick = {navController.navigate("createworkout")}) {
            Icon(
